    ...
    <center>
        ...
        <table>
            <tr>
                ...
                <td style='padding:10px'>
                    <button id="settings_update_fw_btn" type="button" class="btn btn-warning" @click="tab='update'">
                        <svg width='1.3em' height='1.2em' viewBox='0 0 1300 1200'>
                            <g transform='translate(50,1200) scale(1, -1)'>
                ...
                <td style='padding:10px'>
                    <button type="button" id="settings_restart_btn" class="btn btn-danger" @click="restartESP();">
                        <svg width='1.3em' height='1.2em' viewBox='0 0 1300 1200'>
                            <g transform='translate(50,1200) scale(1, -1)'>
                ...
                <td style='padding:10px'>
                    <button type="button" id="settings_refresh_btn" class="btn btn-primary" @click="refreshSettings()">
                        <svg width='1.3em' height='1.2em' viewBox='0 0 1300 1200'>
                            <g transform='translate(50,1200) scale(1, -1)'>
