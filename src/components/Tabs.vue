<template>
    <div class="tab">
    <button class="tablinks" :class="{active:value=='dashboard'}" @click="opentab('dashboard')" id="maintablink">
    ...
    <button class="tablinks"  :class="{active:value=='camera'}" @click="opentab('camera')" id="camtablink">
        <svg width='1.3em' height='1.2em' viewBox='0 0 1300 1200'>
            <g transform='translate(50,1200) scale(1, -1)'>
    ...
    <button class="tablinks hide_it"  :class="{active:value=='printer'}" @click="opentab('printer')" id="configtablink">
        <svg width='1.3em' height='1.2em' viewBox='0 0 1300 1200'>
            <g transform='translate(50,1200) scale(1, -1)'>
    ...
    <button class="tablinks" :class="{active:value=='esp3d'}" @click="opentab('esp3d')" id="settingtablink">
        <svg width='1.3em' height='1.2em' viewBox='0 0 1300 1200'>
            <g transform='translate(50,1200) scale(1, -1)'>
