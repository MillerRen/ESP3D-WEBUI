                ...
                <tbody>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input
                                                    ...
                                                    min="0"
                                                    max="999"
                                                    v-model="preferences.heaterT1SelectedTemp"
                                                    value="0"
                    ...
                    <tr  class="hidden">
                        ...
                        <td>
                            <div class="panel-flex-row">
                                <button
                                    onclick="temperature_heatOff('bed')"
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input
                                                    ...
                                                    min="0"
                                                    max="999"
                                                    v-model="preferences.bedSelectedTemp"
                                                    value="0"
                    ...
                    <tr  class="hidden">
                        ...
                        <td>
                            <div class="panel-flex-row">
                                <button
                                    onclick="temperature_heatOff('chamber')"
                                    class="btn btn-primary"
                                >
                                    <svg width="1.3em" height="1.2em" viewBox="0 0 1300 1200">
                                        <g transform="translate(50,1200) scale(1, -1)">
                                ...
                                <span class="noshowonlowres">&nbsp;&nbsp;</span>
                                <button
                                    onclick="temperature_heatSet('chamber')"
